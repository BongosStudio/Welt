...
VertexShaderOutput VertexShaderFunction(VertexShaderInput input)
{
    ...
    output.Color.rgb = float3(0.2f, 0.2f, 0.2f);
...
float4 PixelShaderFunction(VertexShaderOutput input) : COLOR0
{
    ...
    float2 texCoord = PostProjToScreen(input.Position) + HalfPixel();
    ...
    color.rgb = texColor1.rgb * input.Color.rgb * light * DiffuseColor;
