...
namespace Welt.UI.Components
{
    public class TextComponent : UIComponent
    {
        ...
        public override Cursor Cursor => IsActive && AllowSelection? Cursors.IBeam : Cursor.Current;
        ...
        public static UIProperty<string> TextProperty = new UIProperty<string>("text");
        public static UIProperty<Color> ForegroundProperty = new UIProperty<Color>("foreground");
    }
}