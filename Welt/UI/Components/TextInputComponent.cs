...
namespace Welt.UI.Components
{
    public class TextInputComponent : UIComponent
    {
        ...
        public override float Opacity
        {
            ...
            set { Foreground = new Color(Foreground, value*255); }
        }
        ...
        public override void Draw(GameTime time)
        {
            ...
            if (_text.Count > 0)
            {
                Sprite.DrawString(_spriteFont, builder, new Vector2(X + BorderWidth.Left, Y + BorderWidth.Top), stateColor);
            }
            Sprite.End();
            base.Draw(time);
        }
        ...
        private void InputCharacter(object sender, TextInputEventArgs args)
        {
            ...
            {
                if (keyState[Keys.LeftShift] == KeyState.Up || !Multiline)
                {
