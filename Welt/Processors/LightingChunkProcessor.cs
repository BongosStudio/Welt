...
{
    [Obsolete("Being redone in Welt.Forge.Processors.LightingProcessor. Currently does not work.")]
    public class LightingChunkProcessor : IChunkProcessor
    {
        ...
        //private void PropogateLightSun(ChunkBuilder chunk, byte x, byte y, byte z, byte light)
        //{
        //    var block = chunk.OwnedChunk.GetBlock(x, y, z);
        //    if (block.Id != 0 && block.Id != 5) return;
