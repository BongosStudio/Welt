...
namespace Welt.Components
{
    public class SkyComponent : IVisualComponent
    {
        ...
        public SkyComponent(WeltGame game, GraphicsDevice graphicsDevice, FirstPersonCamera camera, ReadOnlyWorld world)
        {
            Game = game;
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            ProjectionMatrix = Matrix.CreatePerspectiveFieldOfView(MathHelper.PiOver4,
                Graphics.Viewport.AspectRatio, 0.3f, 1000.0f);
        ...
        {
            m_SunEffect.World = Matrix.CreateScale(1, -1, 1) * Matrix.CreateTranslation(m_World.World.SunPos);
        ...
        {
            Graphics.RasterizerState = m_World.World.NormalRaster;

            var currentViewMatrix = m_Camera.View;

            m_Tod = m_World.World.TimeOfDay;
            ...
            foreach (var mesh in SkyDome.Meshes)
            {
                foreach (var currentEffect in mesh.Effects)
                {
                    ...
                    currentEffect.Parameters["TimeOfDay"].SetValue(m_Tod);
                }
                mesh.Draw();
            }
        ...
        private readonly ReadOnlyWorld m_World;
