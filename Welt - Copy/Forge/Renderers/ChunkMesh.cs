...
namespace Welt.Forge.Renderers
{
    public class ChunkMesh : Mesh<VertexPositionNormalTextureEffect>
    {
        ...
        public ChunkMesh(ReadOnlyChunk chunk, WeltGame game, VertexPositionNormalTextureEffect[] vertices, short[] indices)
            : base(game, 1, true)
        {
            Chunk = chunk;
            Vertices = vertices;
        ...
        public ChunkMesh(ReadOnlyChunk chunk, WeltGame game, VertexPositionNormalTextureEffect[] vertices, short[] opaqueIndices, short[] transparentIndices)
            : base(game, 2, true)
        {
            Chunk = chunk;
            Vertices = vertices;
