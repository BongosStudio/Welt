...
namespace Welt.API
{
    ...
    public struct Size : IEquatable<Size>
    {
        ...
        public static Size operator /(float a, Size b)
        {
        ...
        public static Vector3 operator +(Vector3 v, Size s)
        {
            return v + new Vector3(s.Width, s.Height, s.Depth);
        }
        ...
        public static implicit operator Size(Vector3I c)
        {
            return new Size(c.X, c.Y, c.Z);
        }


        public static explicit operator Size(Vector2 c)
        {
            return new Size(c.X, 0, c.Y);
        }
        ...
        public float Diagonal
        {
            get
            {
                return (float)Math.Sqrt(Width * Width +
                                 Height * Height +
                                 Depth * Depth);
            }
        }
